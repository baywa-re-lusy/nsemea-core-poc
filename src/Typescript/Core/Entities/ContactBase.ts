/**
 * Netsuite contact record
 */

import { FieldType, NSTypedRecord } from '../Base/Record'
import * as record from 'N/record'
import { SublistLine, SublistFieldType, Sublist } from '../Base/Sublist'
import { AddressBase } from '../Base/AddressBase'

/**
 * The address _sublist_ (addressbook) on Contact records,
 * not to be confused with the Address _subrecord_.
 * Contact address info is split between this sublist
 * and the subrecord pointed to by the _addressbookaddress_ field.
 */
 ...
 * Contact Base Type
 */
export class ContactBase extends NSTypedRecord {
