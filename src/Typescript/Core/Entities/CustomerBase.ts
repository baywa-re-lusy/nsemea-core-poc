/**
 * Netsuite customer record - contains definitions for most of the built-in fields
 */
...
/**
 * The address _sublist_ on customer records,
 * not to be confused with the Address _subrecord_.
 * Customer address info is split between this sublist
 * and the subrecord pointed to by the _addressbook_ field.
 */
...
export class CustomerBase extends NSTypedRecord {
